...
from easy_memory.embeddings.configs import EmbedderConfig
from easy_memory.llms.configs import LlmConfig
...
class MemoryConfig(BaseModel):
    ...
    history_db_path: str = Field(
        ...
        default=os.path.join(easy_memory_dir, "history.db"),
    )
